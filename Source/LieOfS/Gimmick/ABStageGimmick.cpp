...
AABStageGimmick::AABStageGimmick()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> StageMeshRef(TEXT("/Script/Engine.StaticMesh'/Game/Resources/SM_SQUARE.SM_SQUARE'"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> GateMeshRef(TEXT("/Script/Engine.StaticMesh'/Game/Resources/SM_GATE.SM_GATE'"));
...
{
	//#include "LieOfS/Interface/ABGameInterface.h" 선언되어 있는 상태
