...
AABItemBox::AABItemBox()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> BoxMeshRef(TEXT("/Script/Engine.StaticMesh'/Game/Resources/SM_Env_Breakables_Box1.SM_Env_Breakables_Box1'"));
